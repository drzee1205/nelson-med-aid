...
const supabase_service_js_1 = require("@/backend/supabase_service.js");
const llm_service_js_1 = require("@/backend/llm_service.js");
...
async function ingestMedicalData() {
    ...
    for (const section of textbookData) {
        ...
        for (const chunkText of chunks) {
            ...
            const embedding = await llm_service_js_1.llmService.generateEmbedding(chunkText);
            if (embedding.length > 0) {
                ...
                await supabase_service_js_1.supabaseService.storeMedicalChunks([medicalChunk]);
