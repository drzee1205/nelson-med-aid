...
DROP POLICY IF EXISTS "Users can view their own diagnostic workflows" ON public.diagnostic_workflows;
DROP POLICY IF EXISTS "Users can create their own diagnostic workflows" ON public.diagnostic_workflows;
DROP POLICY IF EXISTS "Users can update their own diagnostic workflows" ON public.diagnostic_workflows;
DROP POLICY IF EXISTS "Service role can manage diagnostic workflows" ON public.diagnostic_workflows;
...
CREATE POLICY "Service role can manage diagnostic workflows"
ON public.diagnostic_workflows FOR ALL
USING (auth.role() = 'service_role'::text);

-- Drop and recreate policies for medical_classifications
DROP POLICY IF EXISTS "Users can view their own medical classifications" ON public.medical_classifications;
DROP POLICY IF EXISTS "Service role can manage medical classifications" ON public.medical_classifications;
...
-- Drop and recreate policies for safety_alerts
...
-- Drop and recreate policies for medical_context_summary
DROP POLICY IF EXISTS "Users can view their own medical context summary" ON public.medical_context_summary;
DROP POLICY IF EXISTS "Service role can manage medical context summary" ON public.medical_context_summary;
